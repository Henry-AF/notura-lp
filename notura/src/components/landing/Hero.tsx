...
export function Hero() {
  ...
  return (
    <section
      className="relative min-h-svh flex items-center justify-center overflow-hidden pt-8"
      style={{
        background:
          "linear-gradient(160deg, #F5F3FF 0%, #EDE9FE 45%, #FAF5FF 100%)",
      }}
    >
      {/* Blobs */}
      <div
        className="absolute top-1/4 -left-32 w-[500px] h-[500px] rounded-full opacity-30 blur-[100px] pointer-events-none"
        style={{ background: "#6851FF" }}
      />
      <div
        className="absolute bottom-0 right-0 w-[400px] h-[400px] rounded-full opacity-20 blur-[120px] pointer-events-none"
        style={{ background: "#BA2BF2" }}
      />

      <div className="max-w-6xl mx-auto px-4 md:px-6 w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center min-h-[80vh] py-8">
          {/* Left: Copy */}
          <div className="flex flex-col items-start">
            <motion.div
              ...
              style={{
                ...
                borderColor: "rgba(104,81,255,0.2)",
                color: "#6851FF",
              }}
              xz
            >
            ...
            >
              Capture ideias.{" "}
              <span style={{ color: "#6851FF" }}>A IA organiza</span> tudo.
            </motion.h1>
            ...
            >
              Notura transforma anotações brutas em conhecimento estruturado —
            ...
            >
              <motion.button
                whileHover={{
                  scale: 1.04,
                  boxShadow: "0 8px 24px rgba(104,81,255,0.4)",
                }}
                whileTap={{ scale: 0.97 }}
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #6851FF 0%, #8B6FFF 100%)",
                  boxShadow: "0 4px 16px rgba(104,81,255,0.35)",
                }}
              >
          ...
          <div className="relative hidden lg:flex items-center justify-center h-[480px]">
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <div
                  ...
                  style={{
                    background: "rgba(104,81,255,0.1)",
                    color: "#6851FF",
                  }}
                >
                  IA ativa
              ...
              <div className="space-y-2 mb-4">
                {[
                  ...
                  <div
                    ...
                    style={{
                      background:
                        i === 0 ? "rgba(104,81,255,0.06)" : "transparent",
                    }}
                  >
              ...
              <div
                className="p-3 rounded-xl border border-violet-100"
                style={{ background: "rgba(104,81,255,0.03)" }}
              >
                ...
                <p className="text-xs text-gray-500 leading-relaxed">
                  Suas notas sobre "produto" e "mercado" se relacionam com o
                  plano de lançamento Q3.
                </p>
              </div>
            </motion.div>
            ...
            {NOTE_CARDS.map((card, i) => (
              ...
              >
                ...
                <div
                  className="px-2 py-1 rounded-full text-[10px] font-medium inline-flex items-center gap-1"
                  style={{
                    background: "rgba(104,81,255,0.08)",
                    color: "#6851FF",
                  }}
